...
static const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_URSALUNA_MOONBLOOD - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_TAUROS_PALDEAN_COMBAT_BREED - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_TAUROS_PALDEAN_BLAZE_BREED - 1] = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_TAUROS_PALDEAN_AQUA_BREED - 1] = ANIM_V_SQUISH_AND_BOUNCE,
